...
accelerate launch \
  ...
  --output_dir=../outputs/pretrain/${dataset_name}/cotvla/${img_recon_loss_weight}/seed_${seed} \
  --policy.phase=${phase} \
  ...
  --steps=${steps} \
  --save_freq=${save_freq} \
  --job_name=${job_name}_${mode}_${img_recon_loss_weight} \
