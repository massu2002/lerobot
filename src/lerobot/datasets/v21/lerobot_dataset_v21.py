...
from lerobot.datasets.v21.compute_stats_v21 import aggregate_stats, compute_episode_stats
from lerobot.datasets.image_writer import AsyncImageWriter, write_image
from lerobot.datasets.v21.utils_v21 import (
    DEFAULT_FEATURES,
    DEFAULT_IMAGE_PATH,
    INFO_PATH,
    TASKS_PATH,
...
from lerobot.datasets.v21.video_utils_v21 import (
    VideoFrame,
    decode_video_frames,
    encode_video_frames,
...
class LeRobotDatasetMetadata:
    def __init__(
        ...
        try:
            ...
            (self.root / self.repo_id / "meta").mkdir(exist_ok=True, parents=True)
